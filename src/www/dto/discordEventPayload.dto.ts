...
export class DiscordEventPayloadDto {
  ...
  event?:
    | {
         ...
         */
        type: DiscordEventType.APPLICATION_AUTHORIZED
         ...
         */
        data: DiscordEventDataForApplicationAuthorized
      }
    | {
        /**
         * Event type
         * @example 'ENTITLEMENT_CREATE'
         */
        type: DiscordEventType.ENTITLEMENT_CREATE
